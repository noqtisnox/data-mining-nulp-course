...
# =========================================================================
def calculate_conditional_entropy(data_subset: pd.DataFrame, target_attribute: str, split_attribute: str) -> float:
  """
...
# =========================================================================
def calculate_information_gain(data_subset: pd.DataFrame, target_attribute: str, split_attribute: str) -> float:
  """
  ...
  conditional_entropy = calculate_conditional_entropy(data_subset, target_attribute, split_attribute)
...
# =========================================================================
def calculate_split_information(data_subset: pd.DataFrame, split_attribute: str) -> float:
  """
...
# =========================================================================
def calculate_gain_ratio(data_subset: pd.DataFrame, target_attribute: str, split_attribute: str) -> float:
  """
...
def get_best_split_attribute(data_subset: pd.DataFrame, target_attribute: str, attributes: list) -> str:
  """
...
def build_tree(data_subset: pd.DataFrame, target_attribute: str, attributes: list) -> dict:
  """
  ...
  for value in data_subset[best_attribute].unique():
      ...
      subset = data_subset[data_subset[best_attribute] == value].drop(columns=[best_attribute])
...
def run_algo():
  ...
  results_df.columns = ['Інф. Приріст (IG)', 'Інф. Розщеплення (SplitInfo)', 'Приріст Відношення (GainRatio)']
  print(results_df.sort_values(by='Приріст Відношення (GainRatio)', ascending=False).to_string(float_format="%.4f"))
